...
export function FixiFullscreenMoment({
  ...
  const gradientColors: [string, string] = t.isDark
    ? ['rgba(10,14,26,0.97)', 'rgba(20,25,41,0.97)']
    : ['rgba(244,246,250,0.98)', 'rgba(255,255,255,0.98)'];
    ...
    >
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <Animated.Text entering={SlideInUp.delay(400).springify()} style={[styles.title, { color: t.colors.text.primary }]}>
            {title}
          </Animated.Text>
          ...
          {subtitle ? (
            <Animated.Text entering={FadeIn.delay(800)} style={[styles.subtitle, { color: t.colors.text.secondary }]}>
              {subtitle}
            </Animated.Text>
          ) : null}
