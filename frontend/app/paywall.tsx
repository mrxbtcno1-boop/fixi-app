...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 16, fontFamily: 'Nunito_900Black', marginBottom: Spacing.sm, textAlign: 'center' },
  featureRow: {
    flexDirection: 'row',
  ...
  featureText: { flex: 1 },
  featureTitle: { fontSize: 14, fontFamily: 'Inter_500Medium', marginBottom: 2 },
  featureSubtitle: { fontSize: 12, fontFamily: 'Inter_400Regular', fontStyle: 'italic' },
